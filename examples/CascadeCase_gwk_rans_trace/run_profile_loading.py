...
plt.figure()
plt.plot(ss_cp,ss_xc,label="ss from experiment")
plt.plot(ps_cp,ps_xc,label="ps from experiment")
plt.plot(ss_xc_cp_numerical,ss_xc_numerical,label="ss from numeric")
plt.plot(ps_xc_cp_numerical,ps_xc_numerical,label="ss from numeric")
plt.show()
