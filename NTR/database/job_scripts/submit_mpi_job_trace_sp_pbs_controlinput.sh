...
##### Mit Controle-File
echo -e "mpirun -d -machinefile \$PBS_NODEFILE TRACE -cgns $WORKDIR/input/$BASENAME -cntl $WORKDIR/input/$CONTROLFILE -lb $WORKDIR/input/$BALANCE_FILE -o TRACE.lst." >> $RUNDIR/tempscript.sh;
